...
public static class InvoicesEndpoint
{
    ...
    public static RouteGroupBuilder MapInvoiceEndpoint(this WebApplication app)
    {
        ...
        group.MapPost("/", async Task<Results<BadRequest<string>, NotFound<string>, CreatedAtRoute>> (CreateInvoiceDto newInvoice, ApplicationDbContext dbContext, ClaimsPrincipal claims) =>
        {
